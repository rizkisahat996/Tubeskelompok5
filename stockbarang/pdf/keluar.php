...
<p style="text-align: center;"><strong><span style="font-family: verdana, geneva, sans-serif;">Laporan Barang Keluar</span></strong></p>
<table border="1">
    <thead>
    ...
    <tbody>
        ...
        $tampildatastok=mysqli_query($koneksi, "select * from barangkeluar m, jenisbarang j where j.id = m.id ");
        $i=1;
        ...
        $query = mysqli_query ($koneksi, "SELECT * FROM barangkeluar");
